...
void  HMC58X3_newValues(int16_t x,int16_t y,int16_t z)
{
	...
	MagSavedCaliData.MagXOffset=	MagMaxMinData.MinMagX+MagMaxMinData.MaxMagX;
	MagSavedCaliData.MagYOffset=	MagMaxMinData.MinMagY+MagMaxMinData.MaxMagY;
	MagSavedCaliData.MagZOffset=	MagMaxMinData.MinMagZ+MagMaxMinData.MaxMagZ;
}
